<html>
	...
	<body>
		...
		<div id="language"><b>EN</b> <a href="index-jp.html">日本</a> <a href="index-cn.html">中国</a></div>
		<p>
		...
		<div id="furndiv" name="#furnTab">
			...
			<div class="furnitureClass invert" id="Window">
				...
				<div class="shipOptions">
					...
					<div><input type="radio" name="window" value="036a" id="p36a" data-pType="full"><label for="p36a">Guardian Office Bar Counter "Beer"<br/>鎮守府カウンターバー「ビール」</label></div>
					<div><input type="radio" name="window" value="036b" id="p36b" data-pType="full"><label for="p36b">Guardian Office Bar Counter "Whiskey"<br/>鎮守府カウンターバー「ウィスキー」</label></div>
					<div><input type="radio" name="window" value="036c" id="p36c" data-pType="full"><label for="p36c">Guardian Office Bar Counter "Sake"<br/>鎮守府カウンターバー「酒」</label></div>
					<div><input type="radio" name="window" value="036d" id="p36d" data-pType="full"><label for="p36d">Guardian Office Bar Counter "Wine"<br/>鎮守府カウンターバー「ワイン」</label></div>
					<div><input type="radio" name="window" value="036e" id="p36e" data-pType="full"><label for="p36e">Guardian Office Bar Counter "Juice"<br/>鎮守府カウンターバー「果汁」</label></div>
					<div><input type="radio" name="window" value="036f" id="p36f" data-pType="full"><label for="p36f">Guardian Office Bar Counter "Rations"<br/>鎮守府カウンターバー「糧食」</label></div>
					<div><input type="radio" name="window" value="036g" id="p36g" data-pType="full"><label for="p36g">Guardian Office Bar Counter "Beer+Saury"<br/>鎮守府カウンターバー「ビール+秋刀」</label></div>
					<div><input type="radio" name="window" value="036i" id="p36i" data-pType="full"><label for="p36i">Guardian Office Bar Counter "Whiskey+Saury"<br/>鎮守府カウンターバー「ウィスキー+秋刀」</label></div>
					<div><input type="radio" name="window" value="036h" id="p36h" data-pType="full"><label for="p36h">Guardian Office Bar Counter "Sake+Saury"<br/>鎮守府カウンターバー「酒+秋刀」</label></div>
					<div><input type="radio" name="window" value="036j" id="p36j" data-pType="full"><label for="p36j">Guardian Office Bar Counter "Wine+Saury"<br/>鎮守府カウンターバー「ワイン+秋刀」</label></div>
					<div><input type="radio" name="window" value="036s" id="p36s" data-pType="full"><label for="p36s">Guardian Office Bar Counter "Rations+Saury"<br/>鎮守府カウンターバー「糧食+秋刀」</label></div>
					<div><input type="radio" name="window" value="036k" id="p36k" data-pType="full"><label for="p36k">Guardian Office Bar Counter "Beer+Turkey"<br/>鎮守府カウンターバー「ビール+七面鳥」</label></div>
					<div><input type="radio" name="window" value="036l" id="p36l" data-pType="full"><label for="p36l">Guardian Office Bar Counter "Whiskey+Hors d'oeuvres"<br/>鎮守府カウンターバー「ウィスキー+オードブル」</label></div>
					<div><input type="radio" name="window" value="036m" id="p36m" data-pType="full"><label for="p36m">Guardian Office Bar Counter "Sake+Sweets"<br/>鎮守府カウンターバー「酒+スイーツ」</label></div>
					<div><input type="radio" name="window" value="036n" id="p36n" data-pType="full"><label for="p36n">Guardian Office Bar Counter "Wine+Panettone"<br/>鎮守府カウンターバー「ワイン+パネットーネ」</label></div>
					<div><input type="radio" name="window" value="036o" id="p36o" data-pType="full"><label for="p36o">Guardian Office Bar Counter "Juice+Cake"<br/>鎮守府カウンターバー「果汁+ケーキ」</label></div>
					<div><input type="radio" name="window" value="036p" id="p36p" data-pType="full"><label for="p36p">Guardian Office Bar Counter "Wine+Stollen"<br/>鎮守府カウンターバー「ワイン+シュトーレン」</label></div>
					<div><input type="radio" name="window" value="036q" id="p36q" data-pType="full"><label for="p36q">Guardian Office Bar Counter "Wine+Pasta"<br/>鎮守府カウンターバー「ワイン+パスタ」</label></div>
					<div><input type="radio" name="window" value="036r" id="p36r" data-pType="full"><label for="p36r">Guardian Office Bar Counter "Rations+Turkey"<br/>鎮守府カウンターバー「糧食+ターキー」</label></div>
		...
		<div id="footer"><p>© 2014-2015 TBES, all rights belong to their respective owners. Last updated: Jan 4 2015</p></div>
