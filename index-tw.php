<html>
	...
	<body>
		<div id="wrapper">
			<h1>艦隊Collection簽名檔產生器</h1>
			<div id="language"><a href="index.php" class="button">EN</a><a href="index-jp.php" class="button">日本語</a><a href="index-cn.php" class="button">简体中文</a><span class="button active">繁體中文</span></div>
			<p>
