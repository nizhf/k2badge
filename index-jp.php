<html>
	...
	<body>
		<div id="wrapper">
			<h1>艦これバッジジェネレータ</h1>
			<div id="language"><a href="index.php" class="button">EN</a><span class="button active">日本語</span><a href="index-cn.php" class="button">简体中文</a><a href="index-tw.php" class="button">繁體中文</a></div>
			<p>
			...
			<div id="canvasDiv">
				...
				<div id="buttonToggles">
					...
					<button type="button" id="displayPoster">ポスター</button>
					<button type="button" id="displayRoom">部屋</button>
				</div>
				<div id="buttons">
					<div>
						<span id="loadingDiv">イメージをロードしています：</span><span id="loadingProgress"></span>
						<button type="button" id="save">セーブ</button>
						<button type="button" id="load">ロード</button>
						<button type="button" id="export">PNGをエクスポートする</button>
					</div>
				</div>
			</div>
			<div id="tabs" class="rounded">
				<ul>
					<li><a href="#ttkTab">オプション</a></li>
					<li><a href="#flagTab">艦隊</a></li>
					<li><a href="#shipTab">改二 + 設計図</a></li>
					<li><a href="#colleTab">ポスターこれ</a></li>
					<li><a href="#furnTab">家具</a></li>
					<li><a href="#customTab">カスタム</a></li>
				</ul>
				<div id="ttkInfo" name="#ttkTab">
					<div>
						<label for="name">提督名</label> <input type="text" name="name" id="name" maxlength="26" placeholder="無名提督">
						<label for="level" class="short">Lv.</label> <input type="number" name="level" id="level" min="1" max="120" placeholder="1 - 120">
						<label for="server" class="short">サーバー</label> <select name="server" id="server">
			...
			<div id="furndiv" name="#furnTab">
				<div class="furnitureClass invert" id="Floor">
					...
					<div class="shipOptions">
						...
						<div><input type="radio" name="floor" value="026" id="f26"><label for="f26">白い高級大理石床</label></div>
				...
				<div id="customInputs" name="#customTab">
					<div><label for="shipImg">カスタム艦娘画像</label> <input type='file' id="shipImg" /> <button type="button" id="shipClear">Clear</button></div>
					<div><label for="customX">艦娘 X</label> <input type="number" id="customX" min="-800" max="800" value="0"> <label for="customY">艦娘 Y</label> <input type="number" id="customY" min="-500" max="500" value="0"></div>
					<div><label for="customZ">艦娘 Zoom</label> <input type="number" id="customZ" min="-50" max="50" value="0">%</div>
					<div><label for="roomY">部屋カメラ Y</label> <input type="number" id="roomY" min="-173" max="134" value="0"></div>
					<div><label for="hexOpa">六角の不透明度</label> <input type="number" id="hexOpa" min="0" max="1" step="0.01" value="0.33"></div>
					<hr/>
					<div><label for="bgImg">背景画像</label> <input type='file' id="bgImg" /> <button type="button" id="bgClear">消す</button></div>
					<div><label for="bgX">背景 X</label> <input type="number" id="bgX" min="-800" max="800" value="0"> <label for="bgY">背景 Y</label> <input type="number" id="bgY" min="-500" max="500" value="0"></div>
					<div><label for="bgZ">背景 Zoom</label> <input type="number" id="bgZ" min="10" max="500" value="100">%</div>
					<label for="bgStretch">画像サイズ変更?</label><input checked type="checkbox" id="bgStretch"/>
					<div style="margin-top: 10px;">
						<button type="button" id="generate">リフレッシュ</button>
					</div>
				</div>
			</div>
