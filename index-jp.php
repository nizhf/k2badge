	...
	<body>
		...
		<div id="tabs">
			...
			<div id="ttkInfo" name="#ttkTab">
				<div>提督名 <input type="text" name="name" maxlength="26" placeholder="無名提督"></div>
				<div>Lv. <input type="number" name="level" min="1" max="120" placeholder="1 - 120"></div>
				<div>サーバー <select name="server">
				...
				<div>プロフィール写真: <input type='file' id="avatarImg" /> <button type="button" id="avatarClear">消す</button></div><br/>
				<div>家具を使う？<input type="checkbox" name="useBG" id="useBG" checked></div> 
				<div>設計図を無視する？<input type="checkbox" name="useBlue" id="useBlue" checked></div> 
				<div>四つ艦隊を見せる?<input type="checkbox" name="k2" id="k2"></div>
			</div>
		...
		<div id="furndiv" name="#furnTab">
			...
			<div id="customInputs" name="#customTab">
				<div>カスタム艦娘画像: <input type='file' id="shipImg" /> <button type="button" id="shipClear">Clear</button></div>
				<div>艦娘 X: <input type="number" id="customX" min="-800" max="800" value="0"> 艦娘 Y: <input type="number" id="customY" min="-500" max="500" value="0"></div>
				<div>艦娘 Zoom: +<input type="number" id="customZ" min="-50" max="50" value="0">%</div>
				<div>部屋カメラ Y: <input type="number" id="roomY" min="-173" max="134" value="0"></div>
				<div>六角の不透明度: <input type="number" id="hexOpa" min="0" max="1" step="0.01" value="0.33"></div>
				<hr/>
				<div>背景画像: <input type='file' id="bgImg" /> <button type="button" id="bgClear">消す</button></div>
				<div>背景 X: <input type="number" id="bgX" min="-800" max="800" value="0"> 背景 Y: <input type="number" id="bgY" min="-500" max="500" value="0"></div>
				<div>背景 Zoom: <input type="number" id="bgZ" min="10" max="500" value="100">%</div>
